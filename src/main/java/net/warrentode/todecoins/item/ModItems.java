...
import net.warrentode.todecoins.item.custom.LuckyPennyItem;

public class ModItems {
    public static DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, TodeCoins.MOD_ID);

    public static final RegistryObject<Item> LUCKYPENNYITEM = ITEMS.register("lucky_penny",
            ()-> new LuckyPennyItem(new Item.Properties().tab(ModCreativeModeTab.TODECOINSTAB).defaultDurability(64).setNoRepair()));
