...
public class ItemsForItemsBuySetTrade implements VillagerTrades.ItemListing {
    ...
    public ItemsForItemsBuySetTrade(ItemStack sellItem, int sellItemCount, ImmutableSet<ItemLike> buyItems, int buyItemsCount, int maxUses, int xpValue) {
        this(sellItem, sellItemCount, buyItems, buyItemsCount, maxUses, xpValue, xpValue);
    }

    public ItemsForItemsBuySetTrade(ItemStack sellItem, int sellItemCount, ImmutableSet<ItemLike> buyItems, int buyItemsCount, int maxUses, int xpValue, float priceMultiplier) {
