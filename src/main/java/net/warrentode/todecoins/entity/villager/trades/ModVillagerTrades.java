    ...
    public static class ForgeEvents {
        ...
        public static void addCustomTrades(VillagerTradesEvent event) {
            ...
            if (event.getType() == ModVillagers.BANKER.get()) {
                trades.get(novice).add(new ItemsForItemsTrade(
                ...
                trades.get(apprentice).add(new ItemsForItemsTrade(
                ...
                trades.get(journeyman).add(new ItemsForItemsTrade(
                ...
                trades.get(expert).add(new ItemsForItemsTrade(
                ...
                trades.get(master).add(new ItemsForItemsTrade(
            ...
            if (event.getType() == ModVillagers.LEPRECHAUN.get()) {
                trades.get(novice).add(new ItemsForItemsTrade(ModItems.EMERALD_QUARTER_BANK_NOTE.get().getDefaultInstance(), 1,
                ...
                trades.get(novice).add(new ItemsForItemsTrade(ModBlocks.POT_OF_GOLD.get().asItem().getDefaultInstance(), 11,
                ...
                trades.get(apprentice).add(new ItemsForItemsTrade(ModItems.EMERALD_HALF_BANK_NOTE.get().getDefaultInstance(), 1,
                ...
                trades.get(apprentice).add(new ItemsForItemsTrade(ModBlocks.POT_OF_GOLD.get().asItem().getDefaultInstance(), 21,
                ...
                trades.get(journeyman).add(new ItemsForItemsTrade(ModItems.EMERALD_BANK_NOTE.get().getDefaultInstance(), 1,
                ...
                trades.get(journeyman).add(new ItemsForItemsTrade(ModBlocks.POT_OF_GOLD.get().asItem().getDefaultInstance(), 43,
                ...
                trades.get(expert).add(new ItemsForItemsTrade(Items.REDSTONE_BLOCK.getDefaultInstance(), 2,
                ...
                trades.get(expert).add(new ItemsSaleSetForItemsTrade(
                        ...
                        ModItems.EMERALD_HALF_BANK_NOTE.get().getDefaultInstance(), 1,
                        UNCOMMON_ITEMS_SUPPLY, XP_LEVEL_4_SELL, HIGH_TIER_PRICE_MULTIPLIER));
                trades.get(expert).add(new ItemsForItemsTrade(Items.PRISMARINE.getDefaultInstance(), 1,
                ...
                trades.get(expert).add(new ItemsSaleSetForItemsTrade(
                        ...
                        UNCOMMON_ITEMS_SUPPLY, XP_LEVEL_4_SELL, HIGH_TIER_PRICE_MULTIPLIER));
                trades.get(master).add(new ItemsForItemsTrade(ModItems.LUCKY_COIN.get().getDefaultInstance(), 1,
                        ModItems.EMERALD_BANK_NOTE.get().getDefaultInstance(), 3,
                        1, XP_LEVEL_4_SELL, HIGH_TIER_PRICE_MULTIPLIER));
                trades.get(master).add(new ItemsForItemsTrade(ModItems.NETHERITE_COIN.get().getDefaultInstance(), 1,
                        ModItems.EMERALD_HALF_BANK_NOTE.get().getDefaultInstance(), 1,
                        UNCOMMON_ITEMS_SUPPLY, XP_LEVEL_4_SELL, HIGH_TIER_PRICE_MULTIPLIER));
            }
        }
