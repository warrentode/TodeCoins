...
public class ItemsAndItemsForItemsTrade implements VillagerTrades.ItemListing {
    ...
    public ItemsAndItemsForItemsTrade(ItemStack sellItemA, int sellItemCountA, ItemStack sellItemB, int sellItemCountB, ItemStack buyItem, int buyItemCount, int maxUses, int xpValue, float priceMultiplier) {
