...
public class CoinPressMenu extends AbstractContainerMenu {
    ...
    public CoinPressMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.COIN_PRESS_MENU.get(), id);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 8, 47));
            this.addSlot(new SlotItemHandler(handler, 1, 44, 47));
            this.addSlot(new ModResultSlot(handler, 2, 116, 47));
        });
