    ...
    public void accept(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
                ...
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        ...
                                        .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_PIGLIN_COIN_DROPS)
                                                .when(EntityTypeTagCondition.isTag(ForgeTags.EntityTypes.PIGLIN_TYPES).build()).setQuality(6))
        ...
        consumer.accept(ModBuiltInLootTables.TODECOINS_ALLAY_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_ALLAY_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_ALLAY_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_ALLAY_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_ALLAY_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_AXOLOTL_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_AXOLOTL_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_AXOLOTL_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_AXOLOTL_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_AXOLOTL_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_BAT_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_BAT_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_BAT_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_BAT_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_BAT_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_BEE_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_BEE_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_BEE_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_BEE_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_BEE_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_CAMEL_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_CAMEL_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_CAMEL_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_CAMEL_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_CAMEL_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_CAT_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_CAT_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_CAT_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_CAT_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_CAT_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_ENDERMAN_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_ENDERMAN_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_ENDERMAN_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_ENDERMAN_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_ENDERMAN_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_OCELOT_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_OCELOT_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_OCELOT_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_OCELOT_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_OCELOT_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_PIGLIN_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_PIGLIN_COIN.get()).when(SPRING).setWeight(1).when(LootItemKilledByPlayerCondition.killedByPlayer()).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.IRON_PIGLIN_COIN.get()).when(SUMMER).setWeight(1).when(LootItemKilledByPlayerCondition.killedByPlayer()).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_PIGLIN_COIN.get()).when(AUTUMN).setWeight(1).when(LootItemKilledByPlayerCondition.killedByPlayer()).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_PIGLIN_COIN.get()).when(WINTER).setWeight(1).when(LootItemKilledByPlayerCondition.killedByPlayer()).setQuality(6))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_CHICKEN_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_CHICKEN_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_CHICKEN_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_CHICKEN_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_CHICKEN_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_CAVE_SPIDER_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_CAVE_SPIDER_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.IRON_CAVE_SPIDER_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_CAVE_SPIDER_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_CAVE_SPIDER_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1))
                                 )
                       );
        consumer.accept(ModBuiltInLootTables.TODECOINS_BLAZE_COIN_DROPS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.COPPER_BLAZE_COIN.get()).when(SPRING).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.IRON_BLAZE_COIN.get()).when(SUMMER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.GOLD_BLAZE_COIN.get()).when(AUTUMN).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1).setQuality(6))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_BLAZE_COIN.get()).when(WINTER).when(LootItemKilledByPlayerCondition.killedByPlayer()).setWeight(1).setQuality(6))
                                 )
                       );
    }
}