package com.github.warrentode.todecoins.block.entity.container.coinpress;
...
public class CoinPressResultSlot extends SlotItemHandler {
    ...
    public void onTake(@NotNull Player player, @NotNull ItemStack stack) {
        ...
        canInteractWithCallable.execute((level, pos) -> {
            ...
            if (this.lastSoundTime != l) {
                level.playSound(null, pos, TCSounds.COINPRESS_TAKE_RESULT.get(), SoundSource.BLOCKS, 1.0F, 1.0F);
    ...
    protected void checkTakeAchievements(ItemStack stack) {
        ...
        if (!this.player.level.isClientSide) {
            coinPress.awardUsedRecipes(this.player, Collections.singletonList(stack));
        }
