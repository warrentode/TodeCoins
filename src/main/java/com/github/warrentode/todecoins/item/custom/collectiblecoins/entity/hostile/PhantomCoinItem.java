...
public class PhantomCoinItem extends CollectibleCoin {
    public PhantomCoinItem(Properties pProperties) {
        super(pProperties);
    }

    @Nullable
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
        return !ModListHandler.curiosLoaded ? null : Curios.createSmiteCharmProvider(stack);
    }
