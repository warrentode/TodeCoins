...
public class SlimeCoinItem extends CollectibleCoin {
    public SlimeCoinItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, @NotNull List<Component> tooltips, @NotNull TooltipFlag pIsAdvanced) {
        tooltips.add(Component.translatable("tooltips.collectible_slime_coin.hover").withStyle(ChatFormatting.GRAY));
