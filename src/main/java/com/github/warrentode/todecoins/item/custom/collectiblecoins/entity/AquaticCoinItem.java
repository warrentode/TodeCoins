...
public class AquaticCoinItem extends CollectibleCoin implements ICurioItem {
    public AquaticCoinItem(Properties pProperties) {
        super(pProperties);
    }
        ...
        return CurioItemCapability.createProvider(new ICurio() {
            ...
            public void curioTick(SlotContext slotContext) {
                ...
                if (livingEntity != null) {
                    ...
                    if (!stack.is(ModTags.Items.DOLPHIN_COIN_SET) && livingEntity.isEyeInFluid(FluidTags.WATER)) {
                        int i = 0;
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, @NotNull List<Component> tooltips, @NotNull TooltipFlag pIsAdvanced) {
        tooltips.add(Component.translatable("tooltips.collectible_aquatic_coin.hover").withStyle(ChatFormatting.GRAY));
