...
public class ModItems {
    ...
    public static final RegistryObject<Item> CURRENCY_STAMP = ITEMS.register("currency_stamp",
            () -> new CurrencyStampItem(new Item.Properties().tab(ModCreativeModeTabs.TODECOINSTAB).defaultDurability(64)));
    ...
    public static final RegistryObject<Item> BIRTHDAY_COIN_2023 = ITEMS.register("collectible_coin_birthday_2023",
            () -> new BirthdayCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // halloween set
    public static final RegistryObject<Item> HALLOWEEN_COIN_2023 = ITEMS.register("collectible_coin_halloween_2023",
            () -> new HalloweenCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // christmas coin
    public static final RegistryObject<Item> CHRISTMAS_COIN_2023 = ITEMS.register("collectible_coin_christmas_2023",
            () -> new ChristmasCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // patron collection
    ...
    public static final RegistryObject<Item> SCHOLAR_OWL_COIN = ITEMS.register("collectible_coin_scholar_owl",
            () -> new LifetimePatronCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> MARSHALL_NASH_CARNATION_COIN = ITEMS.register("collectible_coin_carnation_marshall_nash",
            () -> new CarnationPatronCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> MARSHALL_NASH_COSMOS_COIN = ITEMS.register("collectible_coin_cosmos_marshall_nash",
            () -> new CosmosPatronCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> COPPER_COD_COIN = ITEMS.register("collectible_coin_cod_copper",
            () -> new FishCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_COD_COIN = ITEMS.register("collectible_coin_cod_iron",
            () -> new FishCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_COD_COIN = ITEMS.register("collectible_coin_cod_netherite",
            () -> new FishCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // hero set
    public static final RegistryObject<Item> COPPER_HERO_COIN = ITEMS.register("collectible_coin_hero_copper",
            () -> new HeroCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_HERO_COIN = ITEMS.register("collectible_coin_hero_iron",
            () -> new HeroCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_HERO_COIN = ITEMS.register("collectible_coin_hero_netherite",
            () -> new HeroCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // pufferfish set
    ...
    public static final RegistryObject<Item> COPPER_ALLAY_COIN = ITEMS.register("collectible_coin_allay_copper",
            () -> new AerialCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_ALLAY_COIN = ITEMS.register("collectible_coin_allay_iron",
            () -> new AerialCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_ALLAY_COIN = ITEMS.register("collectible_coin_allay_netherite",
            () -> new AerialCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // axolotl set
    public static final RegistryObject<Item> COPPER_AXOLOTL_COIN = ITEMS.register("collectible_coin_axolotl_copper",
            () -> new AmphibianCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_AXOLOTL_COIN = ITEMS.register("collectible_coin_axolotl_iron",
            () -> new AmphibianCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_AXOLOTL_COIN = ITEMS.register("collectible_coin_axolotl_netherite",
            () -> new AmphibianCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // bat set
    ...
    public static final RegistryObject<Item> COPPER_BEE_COIN = ITEMS.register("collectible_coin_bee_copper",
            () -> new ArthropodCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_BEE_COIN = ITEMS.register("collectible_coin_bee_iron",
            () -> new ArthropodCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_BEE_COIN = ITEMS.register("collectible_coin_bee_netherite",
            () -> new ArthropodCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // blaze set
    public static final RegistryObject<Item> COPPER_BLAZE_COIN = ITEMS.register("collectible_coin_blaze_copper",
            () -> new BlazeCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_BLAZE_COIN = ITEMS.register("collectible_coin_blaze_iron",
            () -> new BlazeCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_BLAZE_COIN = ITEMS.register("collectible_coin_blaze_netherite",
            () -> new BlazeCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // camel set
    public static final RegistryObject<Item> COPPER_CAMEL_COIN = ITEMS.register("collectible_coin_camel_copper",
            () -> new CamelidCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_CAMEL_COIN = ITEMS.register("collectible_coin_camel_iron",
            () -> new CamelidCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_CAMEL_COIN = ITEMS.register("collectible_coin_camel_netherite",
            () -> new CamelidCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // cat set
    public static final RegistryObject<Item> COPPER_CAT_COIN = ITEMS.register("collectible_coin_cat_copper",
            () -> new FelineCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_CAT_COIN = ITEMS.register("collectible_coin_cat_iron",
            () -> new FelineCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_CAT_COIN = ITEMS.register("collectible_coin_cat_netherite",
            () -> new FelineCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // cave spider set
    ...
    public static final RegistryObject<Item> COPPER_COW_COIN = ITEMS.register("collectible_coin_cow_copper",
            () -> new BovineCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_COW_COIN = ITEMS.register("collectible_coin_cow_iron",
            () -> new BovineCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_COW_COIN = ITEMS.register("collectible_coin_cow_netherite",
            () -> new BovineCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // creeper set
    public static final RegistryObject<Item> COPPER_CREEPER_COIN = ITEMS.register("collectible_coin_creeper_copper",
            () -> new CreeperCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_CREEPER_COIN = ITEMS.register("collectible_coin_creeper_iron",
            () -> new CreeperCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_CREEPER_COIN = ITEMS.register("collectible_coin_creeper_netherite",
            () -> new CreeperCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // dolphin set
    public static final RegistryObject<Item> COPPER_DOLPHIN_COIN = ITEMS.register("collectible_coin_dolphin_copper",
            () -> new AquaticCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_DOLPHIN_COIN = ITEMS.register("collectible_coin_dolphin_iron",
            () -> new AquaticCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_DOLPHIN_COIN = ITEMS.register("collectible_coin_dolphin_netherite",
            () -> new AquaticCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // donkey set
    public static final RegistryObject<Item> COPPER_DONKEY_COIN = ITEMS.register("collectible_coin_donkey_copper",
            () -> new EquineCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_DONKEY_COIN = ITEMS.register("collectible_coin_donkey_iron",
            () -> new EquineCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_DONKEY_COIN = ITEMS.register("collectible_coin_donkey_netherite",
            () -> new EquineCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // drowned set
    public static final RegistryObject<Item> COPPER_DROWNED_COIN = ITEMS.register("collectible_coin_drowned_copper",
            () -> new UndeadCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_DROWNED_COIN = ITEMS.register("collectible_coin_drowned_iron",
            () -> new UndeadCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_DROWNED_COIN = ITEMS.register("collectible_coin_drowned_netherite",
            () -> new UndeadCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // elder guardian set
    public static final RegistryObject<Item> COPPER_ELDER_GUARDIAN_COIN = ITEMS.register("collectible_coin_elder_guardian_copper",
            () -> new BossCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_ELDER_GUARDIAN_COIN = ITEMS.register("collectible_coin_elder_guardian_iron",
            () -> new BossCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_ELDER_GUARDIAN_COIN = ITEMS.register("collectible_coin_elder_guardian_netherite",
            () -> new BossCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // ender dragon set
    ...
    public static final RegistryObject<Item> COPPER_ENDERMAN_COIN = ITEMS.register("collectible_coin_enderman_copper",
            () -> new EndermanCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_ENDERMAN_COIN = ITEMS.register("collectible_coin_enderman_iron",
            () -> new EndermanCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_ENDERMAN_COIN = ITEMS.register("collectible_coin_enderman_netherite",
            () -> new EndermanCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // endermite set
    ...
    public static final RegistryObject<Item> COPPER_EVOKER_COIN = ITEMS.register("collectible_coin_evoker_copper",
            () -> new IllagerCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_EVOKER_COIN = ITEMS.register("collectible_coin_evoker_iron",
            () -> new IllagerCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_EVOKER_COIN = ITEMS.register("collectible_coin_evoker_netherite",
            () -> new IllagerCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // fox set
    public static final RegistryObject<Item> COPPER_FOX_COIN = ITEMS.register("collectible_coin_fox_copper",
            () -> new CanineCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_FOX_COIN = ITEMS.register("collectible_coin_fox_iron",
            () -> new CanineCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_FOX_COIN = ITEMS.register("collectible_coin_fox_netherite",
            () -> new CanineCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // frog set
    ...
    public static final RegistryObject<Item> COPPER_HOGLIN_COIN = ITEMS.register("collectible_coin_hoglin_copper",
            () -> new SwineCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_HOGLIN_COIN = ITEMS.register("collectible_coin_hoglin_iron",
            () -> new SwineCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_HOGLIN_COIN = ITEMS.register("collectible_coin_hoglin_netherite",
            () -> new SwineCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // horse set
    ...
    public static final RegistryObject<Item> COPPER_IRON_GOLEM_COIN = ITEMS.register("collectible_coin_iron_golem_copper",
            () -> new GolemCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_IRON_GOLEM_COIN = ITEMS.register("collectible_coin_iron_golem_iron",
            () -> new GolemCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_IRON_GOLEM_COIN = ITEMS.register("collectible_coin_iron_golem_netherite",
            () -> new GolemCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // illusioner set
    ...
    public static final RegistryObject<Item> COPPER_MAGMA_CUBE_COIN = ITEMS.register("collectible_coin_magma_cube_copper",
            () -> new CubeCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_MAGMA_CUBE_COIN = ITEMS.register("collectible_coin_magma_cube_iron",
            () -> new CubeCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_MAGMA_CUBE_COIN = ITEMS.register("collectible_coin_magma_cube_netherite",
            () -> new CubeCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // mooshroom set
    ...
    public static final RegistryObject<Item> COPPER_NUMISMATIST_COIN = ITEMS.register("collectible_coin_numismatist_copper",
            () -> new VillagerCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_NUMISMATIST_COIN = ITEMS.register("collectible_coin_numismatist_iron",
            () -> new VillagerCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_NUMISMATIST_COIN = ITEMS.register("collectible_coin_numismatist_netherite",
            () -> new VillagerCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // ocelot set
    ...
    public static final RegistryObject<Item> COPPER_PANDA_COIN = ITEMS.register("collectible_coin_panda_copper",
            () -> new BearCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_PANDA_COIN = ITEMS.register("collectible_coin_panda_iron",
            () -> new BearCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_PANDA_COIN = ITEMS.register("collectible_coin_panda_netherite",
            () -> new BearCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // parrot set
    ...
    public static final RegistryObject<Item> COPPER_PIGLIN_BRUTE_COIN = ITEMS.register("collectible_coin_piglin_brute_copper",
            () -> new PiglinCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_PIGLIN_BRUTE_COIN = ITEMS.register("collectible_coin_piglin_brute_iron",
            () -> new PiglinCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_PIGLIN_BRUTE_COIN = ITEMS.register("collectible_coin_piglin_brute_netherite",
            () -> new PiglinCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // piglin set
    ...
    public static final RegistryObject<Item> COPPER_RABBIT_COIN = ITEMS.register("collectible_coin_rabbit_copper",
            () -> new RabbitCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_RABBIT_COIN = ITEMS.register("collectible_coin_rabbit_iron",
            () -> new RabbitCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_RABBIT_COIN = ITEMS.register("collectible_coin_rabbit_netherite",
            () -> new RabbitCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // ravager set
    ...
    public static final RegistryObject<Item> COPPER_SHULKER_COIN = ITEMS.register("collectible_coin_shulker_copper",
            () -> new ShulkerCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_SHULKER_COIN = ITEMS.register("collectible_coin_shulker_iron",
            () -> new ShulkerCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_SHULKER_COIN = ITEMS.register("collectible_coin_shulker_netherite",
            () -> new ShulkerCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // silverfish set
    ...
    public static final RegistryObject<Item> COPPER_SNIFFER_COIN = ITEMS.register("collectible_coin_sniffer_copper",
            () -> new SnifferCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_SNIFFER_COIN = ITEMS.register("collectible_coin_sniffer_iron",
            () -> new SnifferCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_SNIFFER_COIN = ITEMS.register("collectible_coin_sniffer_netherite",
            () -> new SnifferCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // snow golem set
    ...
    public static final RegistryObject<Item> COPPER_STRIDER_COIN = ITEMS.register("collectible_coin_strider_copper",
            () -> new StriderCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_STRIDER_COIN = ITEMS.register("collectible_coin_strider_iron",
            () -> new StriderCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_STRIDER_COIN = ITEMS.register("collectible_coin_strider_netherite",
            () -> new StriderCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // tadpole set
    ...
    public static final RegistryObject<Item> COPPER_GLARE_COIN = ITEMS.register("collectible_coin_glare_copper",
            () -> new GlareCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_GLARE_COIN = ITEMS.register("collectible_coin_glare_iron",
            () -> new GlareCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_GLARE_COIN = ITEMS.register("collectible_coin_glare_netherite",
            () -> new GlareCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // iceologer set
    ...
    public static final RegistryObject<Item> COPPER_MAULER_COIN = ITEMS.register("collectible_coin_mauler_copper",
            () -> new MaulerCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_MAULER_COIN = ITEMS.register("collectible_coin_mauler_iron",
            () -> new MaulerCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_MAULER_COIN = ITEMS.register("collectible_coin_mauler_netherite",
            () -> new MaulerCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // tuff_golem set
    ...
    public static final RegistryObject<Item> COPPER_SQUIRREL_COIN = ITEMS.register("collectible_coin_squirrel_copper",
            () -> new RodentCoinItem(new Item.Properties().defaultDurability(95).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    public static final RegistryObject<Item> IRON_SQUIRREL_COIN = ITEMS.register("collectible_coin_squirrel_iron",
            () -> new RodentCoinItem(new Item.Properties().defaultDurability(195).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    ...
    public static final RegistryObject<Item> NETHERITE_SQUIRREL_COIN = ITEMS.register("collectible_coin_squirrel_netherite",
            () -> new RodentCoinItem(new Item.Properties().defaultDurability(480).tab(ModCreativeModeTabs.COLLECTORCOINSTAB)));
    // penguin set
