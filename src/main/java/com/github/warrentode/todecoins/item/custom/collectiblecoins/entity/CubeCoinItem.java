...
public class CubeCoinItem extends CollectibleCoin implements ICurioItem {
    public CubeCoinItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag nbt) {
        return CurioItemCapability.createProvider(new ICurio() {
            ...
            public void onUnequip(SlotContext slotContext, ItemStack newStack) {
                ...
                if (livingEntity != null && stack.is(ModTags.Items.MAGMA_CUBE_COIN_SET)) {
    ...
    public void appendHoverText(@NotNull ItemStack pStack, @Nullable Level pLevel, @NotNull List<Component> tooltips, @NotNull TooltipFlag pIsAdvanced) {
        tooltips.add(Component.translatable("tooltips.collectible_cube_coin.hover").withStyle(ChatFormatting.GRAY));
