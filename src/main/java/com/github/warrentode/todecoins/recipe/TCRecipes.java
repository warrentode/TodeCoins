...
public class TCRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<?>> REMAINDER_SHAPED_SERIALIZER =
            SERIALIZERS.register("crafting_shaped_remainder", () -> RemainderShapedRecipe.Serializer.INSTANCE);
    public static final RegistryObject<RecipeSerializer<?>> REMAINDER_SHAPELESS_SERIALIZER =
            SERIALIZERS.register("crafting_shapeless_remainder", () -> RemainderShapelessRecipe.Serializer.INSTANCE);

    public static final RegistryObject<RecipeSerializer<?>> SPAWN_EGG_SHAPELESS_SERIALIZER =
            SERIALIZERS.register("spawn_egg_shapeless", () -> SpawnEggShapelessRecipe.Serializer.INSTANCE);
