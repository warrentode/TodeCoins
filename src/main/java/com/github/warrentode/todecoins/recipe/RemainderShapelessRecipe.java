...
import com.github.warrentode.todecoins.util.IngredientRemainderUtil;
...
public class RemainderShapelessRecipe extends ShapelessRecipe {
    ...
    public static class Type implements RecipeType<RemainderShapelessRecipe> {
        public static final RemainderShapelessRecipe.Type INSTANCE = new RemainderShapelessRecipe.Type();
    ...
    public @NotNull RecipeSerializer<?> getSerializer() {
        return RemainderShapelessRecipe.Serializer.INSTANCE;
    }
    ...
    public static class Serializer implements RecipeSerializer<RemainderShapelessRecipe> {
        ...
        @SuppressWarnings("unused")
        public static final ResourceLocation ID = ResourceLocation.parse(MODID + "crafting_shapeless_remainder");
