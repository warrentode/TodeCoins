...
public class LootTableForTagTable implements VillagerTrades.ItemListing {
    ...
    public MerchantOffer getOffer(@NotNull Entity trader, @NotNull RandomSource source) {
        if (!(trader.level instanceof ServerLevel)) {
            ...
            LootTable offeredTable = minecraftServer.getLootData().getLootTable(this.offeredTagTable);
            LootTable requestedTable = minecraftServer.getLootData().getLootTable(this.requestedTable);
