...
public class OneLootTableItemForOneItemTrade implements VillagerTrades.ItemListing {
    ...
    public OneLootTableItemForOneItemTrade(ResourceLocation currencyLootTable, ItemStack buyItem, int buyItemCount, int maxUses, int xpValue, float priceMultiplier) {
    ...
    public MerchantOffer getOffer(@NotNull Entity trader, @NotNull RandomSource source) {
        if (!(trader.level instanceof ServerLevel)) {
            ...
            ItemStack sellStack = new ItemStack(currency.get(source.nextInt(currency.size())).getItem());
