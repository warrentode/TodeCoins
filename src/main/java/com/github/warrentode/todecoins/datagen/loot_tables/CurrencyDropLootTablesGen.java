        ...
        consumer.accept(ModBuiltInLootTables.TODECOINS_CURRENCY_DROPS,
                LootTable.lootTable()
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .when(LootItemKilledByPlayerCondition.killedByPlayer())
                                .apply(LootingEnchantFunction.lootingMultiplier(ConstantValue.exactly(0)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_BIRTHDAY_COIN_DROPS).when(BIRTHDAY_EVENT)
                                        .setWeight(1).when(LootItemRandomChanceCondition.randomChance(0.25F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_HALLOWEEN_COIN_DROPS).when(HALLOWEEN_EVENT)
                                        .setWeight(1).when(LootItemRandomChanceCondition.randomChance(0.25F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_CHRISTMAS_COIN_DROPS).when(CHRISTMAS_EVENT)
                                        .setWeight(1).when(LootItemRandomChanceCondition.randomChance(0.25F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_EASTER_COIN_DROPS).when(EASTER_EVENT)
                                        .setWeight(1).when(LootItemRandomChanceCondition.randomChance(0.25F)))
                        ...
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_SPRING_ENTITY_COIN_DROPS)
                                        .setWeight(1).when(SPRING).when(LootItemRandomChanceCondition.randomChance(0.5F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_SUMMER_ENTITY_COIN_DROPS)
                                        .setWeight(1).when(SUMMER).when(LootItemRandomChanceCondition.randomChance(0.5F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_AUTUMN_ENTITY_COIN_DROPS)
                                        .setWeight(1).when(AUTUMN).when(LootItemRandomChanceCondition.randomChance(0.5F)))
                                .add(LootTableReference.lootTableReference(ModBuiltInLootTables.TODECOINS_WINTER_ENTITY_COIN_DROPS)
                                        .setWeight(1).when(WINTER).when(LootItemRandomChanceCondition.randomChance(0.5F)))
                        )
        );
        // injected entity loot table
