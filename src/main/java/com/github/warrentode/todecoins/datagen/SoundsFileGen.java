...
public class SoundsFileGen extends SoundDefinitionsProvider {
    ...
    public void registerSounds() {
        ...
        this.add(ModSounds.PIGLINMERCHANT_HURT, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_DEATH, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_AMBIENT.getId(), definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_STEP, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_RETREAT, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_JEALOUS, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_CELEBRATE, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_ANGER, definition()
        ...
        this.add(ModSounds.PIGLINMERCHANT_EXAMINE, definition()
