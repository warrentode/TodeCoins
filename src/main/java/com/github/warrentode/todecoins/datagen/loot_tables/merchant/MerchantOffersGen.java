    ...
    public void accept(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
        ...
        consumer.accept(TradeLootTables.FLOWER_SELL_TABLE,
                LootTable.lootTable().withPool(LootPool.lootPool()
                        ...
                        .setBonusRolls(ConstantValue.exactly(0))
                        .add(LootItem.lootTableItem(Items.SUNFLOWER)
                                .when(IN_SUNFLOWER_PLAINS.invert().or(IN_ICE_SPIKES.invert()))
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.PEONY)
                                .when(IN_FLOWER_FOREST.invert().or(IN_BIRCH_FOREST.invert())
                                        .or(IN_DARK_FOREST.invert()).or(IN_FOREST.invert())
                        ...
                        .add(LootItem.lootTableItem(Items.LILAC)
                                ...
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(FriendsAndFoesItems.BUTTERCUP.get())
                                .when(IN_FLOWER_FOREST.invert().or(IN_MEADOW.invert())
                                        .or(IN_SUNFLOWER_PLAINS.invert()))
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.LILY_OF_THE_VALLEY)
                                .when(IN_FLOWER_FOREST.invert().or(IN_BIRCH_FOREST.invert())
                                        .or(IN_DARK_FOREST.invert()).or(IN_FOREST.invert())
                                ...
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.CORNFLOWER)
                                .when(IN_FLOWER_FOREST.invert().or(IN_DRIPSTONE_CAVES.invert())
                                        .or(IN_DEEP_DARK.invert()).or(IN_PLAINS.invert())
                                        .or(IN_SUNFLOWER_PLAINS.invert()).or(IN_MEADOW.invert()))
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.OXEYE_DAISY)
                                .when(IN_FLOWER_FOREST.invert().or(IN_DRIPSTONE_CAVES.invert())
                                        .or(IN_DEEP_DARK.invert()).or(IN_PLAINS.invert())
                        ...
                        .add(LootItem.lootTableItem(Items.ALLIUM)
                                .when(IN_FLOWER_FOREST.invert().or(IN_MEADOW.invert()))
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.BLUE_ORCHID).when(IN_SWAMP.invert())
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.POPPY)
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(12))))
                        .add(LootItem.lootTableItem(Items.DANDELION)
