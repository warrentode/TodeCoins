...
public class SpawnEggShapelessRecipeCategory implements IRecipeCategory<SpawnEggShapelessRecipe> {
    public static final ResourceLocation UID = ResourceLocation.parse(MODID+ ":spawn_egg_shapeless");
    ...
    public SpawnEggShapelessRecipeCategory(@NotNull IGuiHelper helper) {
    ...
    @Override
    public @NotNull RecipeType<SpawnEggShapelessRecipe> getRecipeType() {
        return JEIModPlugin.SPAWN_EGG_SHAPELESS_TYPE;
    }
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull SpawnEggShapelessRecipe recipe, @NotNull IFocusGroup group) {
