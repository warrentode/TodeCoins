...
public class CoinPressRecipeCategory implements IRecipeCategory<CoinPressRecipe> {
    public static final ResourceLocation UID = ResourceLocation.parse(MODID+ ":coinpress");
    public static final ResourceLocation TEXTURE = ResourceLocation.parse(MODID+ ":textures/gui/coin_press_gui.png");
    ...
    public CoinPressRecipeCategory(@NotNull IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(TCBlocks.COINPRESSBLOCK.get()));
    }
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull CoinPressRecipe recipe, @NotNull IFocusGroup group) {
        ...
        builder.addSlot(RecipeIngredientRole.OUTPUT, 113, 43).addItemStack(recipe.getResultItem(registryAccess));
    }
}